...
new_full_name = new_first_name.capitalize() + " " + last_name.replace(characters_to_strip, "")

new_lucky_number = int(len(last_name.replace(characters_to_strip, "")) / len(new_first_name))
